			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/faces/avatar.png')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
                ...
                @can('الفواتير')
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            @can('ارشيف الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='Archive') }}"> الأرشيف</a></li>
